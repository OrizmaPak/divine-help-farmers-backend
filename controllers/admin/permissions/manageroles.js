        ...
        if (role) {
            ...
            if (existingRoles.length > 0) {
                ...
                if (status && status !== 'ACTIVE') {
                    ...
                    await pg.query(`UPDATE divine."User" SET permissions = $1 WHERE role = $2`, [status, role]);
                    ...
                    await pg.query(`UPDATE divine."Roles" SET permissions = $1, description = $2, status = $3 WHERE role = $4`, [permissions, description, status, role]);
                ...
                await pg.query(`INSERT INTO divine."Roles" (role, permissions, description, status) VALUES ($1, $2, $3, $4)`, [role, permissions, description, status || 'ACTIVE']);

...
const updatebranch = async (req, res) => {
    ...
    try{
        ...
        if(branch){
            const {rows:checkname} = await pg.query(`SELECT branch FROM divine."Budget" WHERE branch = $1`, [branch]);
            ...
            const {rowCount: updatelocation} = await pg.query(`UPDATE divine."Budget" 

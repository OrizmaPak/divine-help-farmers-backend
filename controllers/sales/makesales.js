...
const makesales = async (req, res) => {
    ...
    try {
        ...
        const { rows: orgSettingsRows } = await pg.query(`SELECT default_cost_of_sales_account, default_income_account FROM divine."Organisationsettings" LIMIT 1`);

                ...
                html: `<!DOCTYPE html>
                        ...
                        <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; color: #333333; margin: 0; padding: 0; line-height: 1.6;">
                            ...
                            <div style="margin: 20px 0;">
                                ...
                                <a href="https://frontend.dhfdev.online/resetpassword.html?passwordtoken=${vtoken}" style="display: block; width: 200px; margin: 20px auto; text-align: center; background-color: #4CAF50; color: #ffffff; padding: 10px; border-radius: 5px; text-decoration: none; font-weight: bold;">Reset Password</a>
                                <p>If the button above doesn't work, copy and paste the following link into your browser:</p>
                                <p><a href="https://frontend.dhfdev.online/resetpassword.html?passwordtoken=${vtoken}" style="color: #4CAF50;">https://frontend.dhfdev.online/resetpassword.html/resetpassword.html?passwordtoken=${vtoken}</a></p>

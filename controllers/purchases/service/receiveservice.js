...
const manageReceiveService = async (req, res) => {
    ...
    const supplierQuery = `SELECT * FROM divine."Supplier" WHERE id = $1 AND status = 'ACTIVE'`;
    ...
    const branchQuery = `SELECT * FROM divine."Branch" WHERE id = $1 AND status = 'ACTIVE'`;
    ...
    const referenceExistsQuery = `SELECT COUNT(*) FROM divine."Service" WHERE reference = $1`;

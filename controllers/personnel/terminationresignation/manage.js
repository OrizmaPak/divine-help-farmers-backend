...
const saveOrUpdateTerminationResignation = async (req, res) => {
    ...
    try {
        ...
        if (id) {
            ...
            query = {
                text: `UPDATE divine."terminationresignation" 
            ...
            // Insert new record
            query = {
                text: `INSERT INTO divine."terminationresignation" (userid, title, type, image, createdby, status)
        ...
        const updateUserRoleQuery = {
            text: `UPDATE divine."User" SET role = $1 WHERE id = $2`,

...
const offlineProcessCollection = async (req, res) => {
    ...
    try {
        ...
        await activityMiddleware(req, userid, 'Transactions processed successfully', 'TRANSACTION');
        ...
        await activityMiddleware(req, userid, 'An unexpected error occurred processing transactions', 'TRANSACTION');
...
module.exports = { offlineProcessCollection };

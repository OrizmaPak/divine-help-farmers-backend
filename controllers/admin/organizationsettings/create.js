...
const organizationsettings = async (req, res) => {
    ...
    const default_tax_account = req.body.default_tax_account || 0;
    const default_excess_account = req.body.default_excess_account || 0;
    ...
    try {
        ...
        const query = await pg.query(`UPDATE divine."Organisationsettings" SET 
            ...
            default_tax_account = COALESCE($61, default_tax_account),
            default_excess_account = COALESCE($62, default_excess_account)
            WHERE id = $63`, [

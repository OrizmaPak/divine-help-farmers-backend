...
const createOrUpdateAccount = async (req, res) => {
    ...
    try {
        ...
        if (id) {
            ...
            const { rows: existingAccountRows } = await pg.query(`SELECT * FROM divine."Accounts" WHERE id = $1`, [id]);
        ...
        if (id) {
            ...
            await pg.query(`UPDATE divine."Accounts" SET groupname = $1, description = $2, dateadded = $3, createdby = $4 WHERE id = $5`, 
